...
vim.api.nvim_command('nnoremap G Gzz')
...
vim.api.nvim_command('nnoremap ¹ :BufferLineGoToBuffer 1 <CR>')
vim.api.nvim_command('nnoremap ² :BufferLineGoToBuffer 2 <CR>')
vim.api.nvim_command('nnoremap ³ :BufferLineGoToBuffer 3 <CR>')
vim.api.nvim_command('nnoremap ¼ :BufferLineGoToBuffer 4 <CR>')
vim.api.nvim_command('nnoremap ½ :BufferLineGoToBuffer 5 <CR>')
vim.api.nvim_command('nnoremap ¬ :BufferLineGoToBuffer 6 <CR>')
